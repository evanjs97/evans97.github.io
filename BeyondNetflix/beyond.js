...
class TopAll extends React.Component {
  render(){
    return(
      <div>
        <h2 className="light_title pb-0">Beyond Netflix</h2>
        ...
        <div className="row text-left">
          ...
          <div className="col-xs-12 col-sm-10 col-md-8 col-lg-6">
            <p>First off this list will not be a review of any movie but rather, a list of 10 movies which I believe
              ...
              the movies merits. The list will be ordered, both by comparing how great the movie is, to how well known
              it is. However, all these movies are well worth watching, so I suggest you do if you haven't already.
              Now, here's the list!</p>
            <img src="../Images/10list/argo.jpg" className="img-fluid text-center"></img>
            <p></p>
            <h5>#10: Argo</h5>
            <p>Released in 2012 to huge critical praise, <a href="https://en.wikipedia.org/wiki/Argo" target="_blank">Argo</a> is
              probably the most well-known movie on this list, which
              is also why its not higher up in my rankings. This historical drama adapted from multiple accounts of
              the <a href="https://en.wikipedia.org/wiki/Canadian_Caper" target="_blank">"Canadian Caper"</a>, a joint
              CIA and Canadian Government rescue operation of 6 American diplomats.
              Although you may have already seen this title, it is a must watch if you haven't.</p>
            <img src="../Images/10list/tucker_and_dale_vs_evil.jpg" className="img-fluid text-center"></img>
            <p></p>
            <h5>#9: Tucker and Dale vs. Evil</h5>
            <p><a href="https://en.wikipedia.org/wiki/Tucker_%26_Dale_vs._Evil" target="_blank">Tucker and Dale vs. Evil</a> is a
              comedy horror film following two average hillbillies camping at their cabin.
              The horror starts when they are mistaken for killers by a group of college students. Tucker and Dale is a
              very enjoyable horror movie and is even streaming on Netflix right now. That being said, Tucker and Dale
              is not necessarily a movie for everyone However if your a fan of horror movies, and especially for fans
              of A Cabin in the Woods, this movie is for you.</p>
            <img src="../Images/10list/catch_me_if_you_can.jpg" className="img-fluid text-center"></img>
            <p></p>
            <h5>#8 Catch Me if You Can</h5>
            ...
            <p><a href="https://en.wikipedia.org/wiki/Battle_Royale_(film)" target="_blank">This</a> Japanese film is
              essentially the hunger games, before the hunger games existed. Sadly it did not
